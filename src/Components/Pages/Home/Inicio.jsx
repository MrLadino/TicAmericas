  ...
  return (
    <div className="flex flex-col min-h-screen bg-white text-black">
      <main className="flex-grow">
        {/* Título */}
        <h1 className="text-center mt-16 text-6xl font-extrabold text-black">
          Bienvenido a tu experiencia personalizada
        </h1>

        {/* Slider de imágenes */}
        <div className="relative w-full lg:w-3/4 mx-auto mt-12 shadow-xl rounded-lg overflow-hidden">
          <img
            src={images[currentImage]}
            alt={`Slider ${currentImage + 1}`}
            className="w-full h-96 object-cover transition-all duration-1000 ease-in-out transform hover:scale-105"
          />
        </div>

        {/* Sección de Beneficios */}
        <div className="bg-gray-200 py-12 px-6 mt-16 mx-auto max-w-screen-lg rounded-lg shadow-lg">
        ...
        <div className="py-16 mt-16 bg-black text-white">
          ...
          <div className="flex flex-wrap justify-center space-x-6">
            <div className="w-full sm:w-1/2 md:w-1/3 p-6">
              <blockquote className="bg-red-600 p-8 rounded-lg shadow-lg">
